...
<head>
    ...
    <link href="../../res/libraries/fontawesome-iconpicker-1.0.0/dist/css/fontawesome-iconpicker.min.css"
                    ...
                    <div class="panel-body">
                        <form method="post" action="../../php/user/create.php">
                            ...
                            <ul class="nav nav-tabs" role="tablist" style="margin-bottom: 20px;">
                                ...
                                <li><a href="#names" role="tab" data-toggle="tab">Names<span class="mandatory">*</span></a>
                                </li>
                                <li><a href="#contact" role="tab" data-toggle="tab">Contact<span
                                            class="mandatory">*</span></a>
                                </li>
                                <li><a href="#images" role="tab" data-toggle="tab">Images<span
                                            class="mandatory">*</span></a>
                                </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="basic">
                                    ...
                                    <label for="userConfirmPass">Confirm Password: <span
                                ...
                                <div class="tab-pane" id="names">
                                    ...
                                    <input id="userContactFullnamePrivate" name="userContactFullnamePrivate"
                                           type="checkbox">
                                </div>
                                <div class="tab-pane" id="contact">
                                    <label for="userContactEmail">Email address: <span
                                            class="mandatory">*</span></label>
                                    <input id="userContactEmail" class="form-control" type="text"
                                    ...
                                    <input id="userContactPhone" class="form-control" type="text"
                                    ...
                                    <input id="userContactAddress" class="form-control" type="text"
                                           name="userContactAddress">

                                    <label for="userContactAddressPrivate">Private: </label>
                                    <input id="userContactAddressPrivate" type="checkbox"
                                           name="userContactAddressPrivate">
                                </div>
                                <div class="tab-pane" id="images">
                                    <label for="userImageProfile">Profile Image: <span
                                            class="mandatory">*</span></label>

                                    <p>(For best fit use 250x250)</p>
                                    <input type="url" class="form-control" id="userImageProfile"
                            ...
                            <hr>
                            <button type="submit" class="btn btn-block btn-primary" style="margin-top: 10px;">
                                Create
                            </button>
                        </form>
                    </div>
