...
<head>
    ...
    <title>Cheltenham Hackspace > Admin Console > Gatherings</title>
...
<div id="wrapper">
    ...
    <div id="page-wrapper" style="margin-top: 25px;">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Gatherings</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="row">
                        ...
                        <div class="dataTable_wrapper">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tr>
                                    ...
                                    <th>Description</th>
                                    <th style="width: 11%">Occurring</th>
                                ...
                                foreach ($rows as $record) {
                                    ...
                                    echo "<td>" . date("d-m-Y \\a\\t H:i:s", $record['occurring']) . "</td>";
                                    echo "<td>" . $record['location_address'] . "</td>";
                                    echo "</tr>";
                                }
                                ?>
                                </tbody>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                        <a class="btn btn-block btn-primary" href="../../pages/gathering/edit/create.php">Create a gathering</a>
                    </div>
                    <!-- /.panel-body -->
                </div>
                <!-- /.panel -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                        <form method="post" action="../../php/admin/gathering/gathering-remove.php">
                            <div class="form-group">
                                <label for="gth-frm-id">Id: </label>
                                <select class="form-control" id="gth-frm-id" name="gth-frm-id">
                                    <?php
                                    foreach ($rows as $record) {
